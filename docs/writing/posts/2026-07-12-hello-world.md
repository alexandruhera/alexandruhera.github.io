...
This site is a static build with no client-side framework, no third-party
requests, a content security policy with hashed inline scripts, and a contact
form that runs on a serverless function instead of a forms SaaS.
