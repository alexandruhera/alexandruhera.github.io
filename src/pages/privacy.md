...
title: Privacy
description: "Privacy notice for alexandruhera.com — what data is processed, why, and your rights."
---
...
- No third-party embeds — fonts and all assets are served from this domain.
...
If the way this site handles data ever changes — for example if analytics
were added — this notice will be updated first, with the date above.
